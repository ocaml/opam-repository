...
* To date, there is no automation involved in deciding whether or not to accept a new project into `opam-repository`. In this regard, it is permitted for a proposal for a new project to be submitted automatically, **but** any subsequent discussions regarding that proposal must take place between humans. Any response generated by AI will be rejected.
